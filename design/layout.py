...
def write(path=None):
    """Write the board, leaving the project it belongs to alone.
    ...
    into ignores. The save therefore goes through the toolkit, which
    restores the project documents' own bytes.
    """
    board, _ = build()
    fill_zones(board)
